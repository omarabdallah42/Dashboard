...
const ProductInfoDialog = ({ typeEdite, open, onClose, onSave, ItemEdite }) => {
  ...
  const handleSave = () => {
    if (typeEdite === "edite") {
      ...
      if (
        itemEditValue.title === "" ||
        itemEditValue.price === null ||
        itemEditValue.category === "" ||
        itemEditValue.description === ""
      ) {
        SetActiveAlert({ type: "error", message: "Please fill all the fields", show: true });
      } else if (
        itemEditValue.title.trim() ||
        itemEditValue.category.trim() ||
        itemEditValue.description.trim()
      ) {
   ...
   <div className="ProductInfo-Buttons" style={{ marginTop: "20px" }}>
          ...
          <div className="ProductInfo-Image">
              <div className="Main-Image">
                <img src={itemEditValue.src || src} alt="main product" />
              </div>
              <div className="Sub-Images">{ShowSrcImage}</div>
            </div>
          </div>
        ) : (
          <div className="ProductInfo desktop">
            <div className="ProductInfo-Details">
              <div className="ProductInfo-Details-show-inputs">
                <div className="Title">
                  <h2>Enter Product Name</h2>
              ...
              <div
                className="ProductInfo-Details-show-categories"
